<?php
class Admin_AnalyticsAppController extends Nexva_Controller_Action_Admin_MasterController {
    ...
    function indexAction() {
        ...
        if (!$productId) {
            $this->_redirect(ADMIN_PROJECT_BASEPATH.'analytics');
        }
        ...
        $viewByDevice   = $views->getAppViewsByDevice($this->_getCpId(), $startDateView, $endDateView, 8, $productId);
