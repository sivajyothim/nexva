...
class Api_MobilemoneyController extends Zend_Controller_Action {
    ...
    {
        /*if($_SERVER['REMOTE_ADDR'] != 'requested ip'){
        ...
        $server = new MobilemoneySoapServer(null, array('uri' => 'http://api.nexva.com/mobilemoney/confirm-third-party-payment-request'));
    ...
    public function confirmThirdPartyPaymentRequestMtnUgandaAction()
    {
    	/*if($_SERVER['REMOTE_ADDR'] != 'requested ip'){
    	 die('Access Forbidden');
    	}*/
    ...
    public function confirmThirdPartyPaymentRequestMtnCiAction()
    {
    	/*if($_SERVER['REMOTE_ADDR'] != 'requested ip'){
    	 die('Access Forbidden');
    	}*/
    	...
    	$server = new MobilemoneySoapServer(null, array('uri' => 'http://api.nexva.com/mobilemoney/confirm-third-party-payment-request-mtn-ci'));
    ...
    public function confirmThirdPartyPaymentRequestMtnBeninAction()
    {
    	/*if($_SERVER['REMOTE_ADDR'] != 'requested ip'){
    	 die('Access Forbidden');
    	}*/
    	...
    	$server = new MobilemoneySoapServer(null, array('uri' => 'http://api.nexva.com/mobilemoney/confirm-third-party-payment-request-mtn-benin'));
...
class MobilemoneySoapServer extends Zend_Soap_Server
{
    ...
    public function handle($request = null)
    {
        ...
        if(($parameters[9] != '01') && ($parameters[2] != $mobileMoney->accRef)){
            return;
        }*/
