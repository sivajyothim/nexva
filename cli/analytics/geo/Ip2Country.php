...
class Ip2Country
{
	...
	public function load($ip)
	{
		...
		{
			$this->property['countryCode'] = '?DBNOTFOUND';
			$this->property['country'] = '?DBNOTFOUND';
		...
		$this->property['countryCode'] = '?COUNTRY_UNIDENTIFIED';
		$this->property['country'] = '?COUNTRY_UNIDENTIFIED';
