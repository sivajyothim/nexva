...
class paypal_class {
   ...
   function submit_paypal_post() {
      ...
      echo "<html>\n";
      echo "<head><title>Processing Payment...</title><LINK href=\"../images/style.css\" rel=stylesheet type=text/css></head>\n";
      echo "<body onLoad=\"document.forms['paypal_form'].submit();\">\n";
      echo "<center><span class=\"text-small-3\">Please wait, your order is processing!!!";
      ...
      echo "<center><br/><br/><span class=\"text-small-3\">If you are not automatically redirected to ";
      echo "paypal within 5 seconds...</span><br/><br/>\n";
      echo "<input type=\"submit\" value=\"Click Here\" class=\"input1\"></center>\n";
