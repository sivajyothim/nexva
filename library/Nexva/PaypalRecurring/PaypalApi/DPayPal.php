...
class DPayPal {
    //API Credentials
    protected $username = "eCarrot_api1.specteri.com"; //PayPal API username
    protected $password = "LLVBQFV8A75RZKSU"; //PayPal API password
    protected $apiSignature = "AOu1gSw7rsh2hMiKGgAy873K-5WWAOIlpmoBapl7FfkiAbcpeLe8ouO6"; //PayPal API signature
