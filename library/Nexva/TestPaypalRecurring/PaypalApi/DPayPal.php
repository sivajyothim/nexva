...
class DPayPal {
    //API Credentials
    protected $username = "eCarrot1_api1.specteri.com"; //PayPal API username
    protected $password = "SDAGPVDC6GS6RP53"; //PayPal API password
    protected $apiSignature = "AUMv9jf.LFB8410gJx9upsi16Ez6AuEM31I3v1yPwxCx2MkEP8lVz8pD"; //PayPal API signature
    protected $apiVersion = "86"; //Set PayPal API version
