...
$(document).ready(function(){
    ...
    $('.remove_all').click(function(){
        ...
        if(confirm_delete){
            ...
            //        //        $('.loading_bar').html('<p align="center"><img src="<?php echo ADMIN_PROJECT_BASEPATH;?>assets/img/global/ajax-loader.gif" width="220" height="19" /></p>');
...
function query_devices(switcher, query){
    ...
    if(switcher == 'search'){
        $(".search_phones").show();
        $('.search_phones').html('<p align="center"><img src="<?php echo ADMIN_PROJECT_BASEPATH;?>assets/img/global/ajax-loader.gif" width="220" height="19" /></p>');
        ...
        $(".operations").show();
        $(".phones").show();
        $('.phones').html('<p align="center"><img src="<?php echo ADMIN_PROJECT_BASEPATH;?>assets/img/global/ajax-loader.gif" width="220" height="19" /></p>');
        $.getJSON('/async/getdevices', {
            q:switcher,
            search:query
        }, parse_info);
...
function show_selected_devices() {
    ...
    if(btn_val == 'Show Currently Selected Devices') {
        ...
        //        $(".operations").empty();
        //        $(".operations").hide();
        $('.phones_selected').html('<p align="center"><img src="<?php echo ADMIN_PROJECT_BASEPATH;?>assets/img/global/ajax-loader.gif" width="220" height="19" /></p>');
