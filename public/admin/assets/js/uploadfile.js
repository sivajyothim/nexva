 ...
 **/
    ...
    */
    ...
    var build_name 	= $("#build_name").val().replace(/[^a-zA-Z0-9-_ ()]/ig, ""); 
    ...
    $('#file').uploadify({
        ...
        'onError'     : function (event,ID,fileObj,errorObj) {
          ...
          console.log('error');
            ...
            alert(errorObj.type + ' Error occured, please contact site administrator if this error persists : ' + errorObj.info);
        }
