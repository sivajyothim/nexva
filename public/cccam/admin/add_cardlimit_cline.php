          ...
          <form id="form" NAME="form" method="post" onSubmit="return nameempty();" action="insert_confirm.php">
            <table width="650" border="0" align="center" cellpadding="0" cellspacing="1">
              ...
              <tr>
                ...
                <td bgcolor="#5B7CFF"><select name="cline_cardlimit" class="LoginBox" id="cline_cardlimit">
              ...
              <tr>
                ...
                <td bgcolor="#5B7CFF"><input name="add" type="hidden" id="add" value="cardlimit_cline" />
