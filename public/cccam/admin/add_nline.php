      ...
      <tr>
        <td valign="top" bgcolor="#84C1DF"><table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <table width="650" border="0" align="center" cellpadding="0" cellspacing="0" class="TitoloMenu">
            <tr>
              <td bgcolor="#003366">Add N-Line ::</td>
              </tr>
        </table>
          <table width="650" border="0" align="center" cellpadding="0" cellspacing="0" class="TitoloMenu">
            <tr>
            ...
            <table width="650" border="0" align="center" cellpadding="0" cellspacing="1">
              <tr>
                ...
                <td bgcolor="#5B7CFF"><label for="user_name"></label>
                  <input name="nline_hostname" type="text" class="LoginBox" id="textfield2" /></td>
              </tr>
              <tr>
                <td bgcolor="#5B7CFF" class="TestoContenuto">Port ::</td>
                <td bgcolor="#5B7CFF"><input name="nline_port" type="text" class="LoginBox" id="nline_port" size="10" /></td>
              </tr>
              <tr>
                <td bgcolor="#5B7CFF" class="TestoContenuto">Username ::</td>
                <td bgcolor="#5B7CFF"><input name="nline_username" type="text" class="LoginBox" id="textfield3" /></td>
              </tr>
              <tr>
                <td bgcolor="#5B7CFF" class="TestoContenuto">Password ::</td>
                <td bgcolor="#5B7CFF"><input name="nline_password" type="text" class="LoginBox" id="textfield4" /></td>
              </tr>
              <tr>
                <td bgcolor="#5B7CFF" class="TestoContenuto">Des Key ::</td>
                <td bgcolor="#5B7CFF"><input name="nline_des" type="text" class="LoginBox" id="textfield5" size="40" /></td>
              </tr>
              <tr>
                <td bgcolor="#5B7CFF" class="TestoContenuto">Hops ::</td>
                <td bgcolor="#5B7CFF"><input name="nline_hops" type="text" class="LoginBox" id="textfield6" value="256" size="10" /></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td bgcolor="#5B7CFF"><input name="add_nline" type="hidden" id="add_nline" value="ok" /></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
