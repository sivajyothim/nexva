      ...
      <tr>
        <td valign="top" bgcolor="#84C1DF"><table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <table width="650" border="0" align="center" cellpadding="0" cellspacing="0" class="TitoloMenu">
            <tr>
              <td bgcolor="#003366">Add Reader ::</td>
              </tr>
        </table>
          <table width="650" border="0" align="center" cellpadding="0" cellspacing="0" class="TitoloMenu">
            <tr>
          ...
          <form id="form" NAME="form" method="post" action="insert_confirm.php">
            <table width="650" border="0" align="center" cellpadding="0" cellspacing="1">
              <tr>
                <td bgcolor="#5B7CFF" class="TestoContenuto">Reader Value Name ::</td>
                <td bgcolor="#5B7CFF"><label for="reader_value_name"></label>
                  <input name="reader_value_name" type="text" class="LoginBox" id="reader_value_name" size="40" /></td>
              </tr>
              <tr>
                <td bgcolor="#5B7CFF" class="TestoContenuto">Reader Value ::</td>
                <td bgcolor="#5B7CFF"><input name="reader_value" type="text" class="LoginBox" id="textfield2" size="20" /></td>
              </tr>
              <tr>
                <td width="250" bgcolor="#5B7CFF" class="TestoContenuto">Reader Misc ::</td>
                <td bgcolor="#5B7CFF"><input name="reader_misc" type="text" class="LoginBox" id="reader_misc" size="20" /></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td><input name="add_reader" type="hidden" id="add_reader" value="ok" /></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
