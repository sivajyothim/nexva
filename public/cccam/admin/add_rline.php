      ...
      <tr>
        <td valign="top" bgcolor="#84C1DF"><table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <table width="650" border="0" align="center" cellpadding="0" cellspacing="0" class="TitoloMenu">
            <tr>
              <td bgcolor="#003366">Add R-Line ::</td>
              </tr>
        </table>
          <table width="650" border="0" align="center" cellpadding="0" cellspacing="0" class="TitoloMenu">
            <tr>
            ...
            <table width="650" border="0" align="center" cellpadding="0" cellspacing="1">
              <tr>
                ...
                <td bgcolor="#5B7CFF"><label for="user_name"></label>
                  <input name="rline_hostname" type="text" class="LoginBox" id="textfield2" /></td>
              </tr>
              <tr>
                <td bgcolor="#5B7CFF" class="TestoContenuto">Port ::</td>
                <td bgcolor="#5B7CFF"><input name="rline_port" type="text" class="LoginBox" id="textfield13" size="10" /></td>
              </tr>
              <tr>
                <td bgcolor="#5B7CFF" class="TestoContenuto">Caid ::</td>
                <td bgcolor="#5B7CFF"><input name="rline_caid" type="text" class="LoginBox" id="textfield4" size="15" /></td>
              </tr>
              <tr>
                <td bgcolor="#5B7CFF" class="TestoContenuto">Ident ::</td>
                <td bgcolor="#5B7CFF"><input name="rline_ident" type="text" class="LoginBox" id="textfield5" size="15" /></td>
              </tr>
              <tr>
                <td bgcolor="#5B7CFF" class="TestoContenuto">Hops ::</td>
                <td bgcolor="#5B7CFF"><input name="rline_hops" type="text" class="LoginBox" id="textfield6" size="10" /></td>
              </tr>
              <tr>
                <td bgcolor="#5B7CFF" class="TestoContenuto">&nbsp;</td>
                <td bgcolor="#5B7CFF"><input name="add_rline" type="hidden" id="add_rline" value="ok" /></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
