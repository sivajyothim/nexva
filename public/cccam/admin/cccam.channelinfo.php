...
<table width="650" border="0" align="center" cellpadding="0" cellspacing="1">
              ...
              <tr>
                ...
                <td height="20" bgcolor="#5B7CFF" ><a href="cccam.channelinfo.make.php?provider=<?php echo $result_select['chan_provider'];?>"><img src="../img/buildings.png" title="Make" width="16" height="16" border="0" /></a></td>
              </tr>
              <?php } ?>
              <tr>
                <td bgcolor="#5B7CFF" >&nbsp;</td>
