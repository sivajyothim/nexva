      ...
      <tr>
        <td valign="top" bgcolor="#84C1DF"><table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <table width="650" border="0" align="center" cellpadding="0" cellspacing="0" class="TitoloMenu">
            <tr>
              <td bgcolor="#003366">Client Update FTP Preview ::</td>
              </tr>
        </table>
          <table width="650" border="0" align="center" cellpadding="0" cellspacing="0" class="TitoloMenu">
            <tr>
...
<table width="650" border="0" align="center" cellpadding="0" cellspacing="1">
              <tr>
                <td height="20" valign="middle" bgcolor="#FFFFFF">
                  ...
                  <div align="center">
                    <textarea name="textarea" cols="86" rows="20" readonly="readonly" id="textarea"><?php
				$file = fopen("../script/client_update", "r") or exit("Unable to open file!");
