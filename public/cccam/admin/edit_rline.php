...
$sql_rline = "SELECT * FROM cccam_rline WHERE rline_id = '$rline_id'";
$query_rline = mysql_query($sql_rline);
$result_rline = mysql_fetch_assoc($query_rline);
      ...
      <tr>
        <td valign="top" bgcolor="#84C1DF"><table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <table width="650" border="0" align="center" cellpadding="0" cellspacing="0" class="TitoloMenu">
            <tr>
              <td bgcolor="#003366">Edit R-Line ::</td>
              </tr>
        </table>
          <table width="650" border="0" align="center" cellpadding="0" cellspacing="0" class="TitoloMenu">
            <tr>
            ...
            <table width="650" border="0" align="center" cellpadding="0" cellspacing="1">
              <tr>
                ...
                <td bgcolor="#5B7CFF"><label for="user_name"></label>
                  <input name="rline_hostname" type="text" class="LoginBox" id="textfield2" value="<?php echo $result_rline['rline_hostname'];?>" /></td>
              </tr>
              <tr>
                <td bgcolor="#5B7CFF" class="TestoContenuto">Port ::</td>
                <td bgcolor="#5B7CFF"><input name="rline_port" type="text" class="LoginBox" id="textfield13" value="<?php echo $result_rline['rline_port'];?>" size="10" /></td>
              </tr>
              <tr>
                <td bgcolor="#5B7CFF" class="TestoContenuto">Caid ::</td>
                <td bgcolor="#5B7CFF"><input name="rline_caid" type="text" class="LoginBox" id="textfield4" value="<?php echo $result_rline['rline_caid'];?>" size="15" /></td>
              </tr>
              <tr>
                <td bgcolor="#5B7CFF" class="TestoContenuto">Ident ::</td>
                <td bgcolor="#5B7CFF"><input name="rline_ident" type="text" class="LoginBox" id="textfield5" value="<?php echo $result_rline['rline_ident'];?>" size="15" /></td>
              </tr>
              <tr>
                <td bgcolor="#5B7CFF" class="TestoContenuto">Hops ::</td>
                <td bgcolor="#5B7CFF"><input name="rline_hops" type="text" class="LoginBox" id="textfield6" value="<?php echo $result_rline['rline_hops'];?>" size="10" /></td>
              </tr>
              <tr>
                <td bgcolor="#5B7CFF" class="TestoContenuto">&nbsp;</td>
                <td bgcolor="#5B7CFF"><input name="rline_id" type="hidden" id="rline_id" value="<?php echo $_GET['rline_id'];?>" />
                  <input name="edit_rline" type="hidden" id="edit_rline" value="ok" /></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
