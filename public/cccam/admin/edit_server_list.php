...
$sql_server = "SELECT * FROM cccam_server_list WHERE server_id = '$id'";
$query_server = mysql_query($sql_server);
$result_server = mysql_fetch_assoc($query_server);
      ...
      <tr>
        <td valign="top" bgcolor="#84C1DF"><table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <table width="650" border="0" align="center" cellpadding="0" cellspacing="0" class="TitoloMenu">
            <tr>
              <td bgcolor="#003366">Edit Server ::</td>
              </tr>
        </table>
          <table width="650" border="0" align="center" cellpadding="0" cellspacing="0" class="TitoloMenu">
            <tr>
            ...
            <table width="650" border="0" align="center" cellpadding="0" cellspacing="1">
              <tr>
                ...
                <td height="20" bgcolor="#5B7CFF" class="TestoContenuto"><label for="server_host"></label>
                  <input name="server_host" type="text" class="LoginBox" id="server_host" value="<?php echo $result_server['server_host'];?>" /></td>
              </tr>
              <tr>
                ...
                <td height="20" bgcolor="#5B7CFF" class="TestoContenuto"><label for="server_port"></label>
                  <input name="server_port" type="text" class="LoginBox" id="server_port" value="<?php echo $result_server['server_port'];?>" /></td>
              </tr>
              <tr>
                ...
                <td height="20" bgcolor="#5B7CFF" class="TestoContenuto"><label for="server_wantemu"></label>
                  <select name="server_wantemu" class="LoginBox" id="server_wantemu">
                    ...
                    <option value="<?php echo $result_wemu['wantemus_value'];?>"<?php if($result_server['server_wantemu'] == $result_wemu['wantemus_value']) { echo " selected=\"selected\""; }?>><?php echo $result_wemu['wantemus_value'];?></option>
                    <?php }?>
                  </select></td>
              </tr>
              <tr>
                ...
                <td height="20" bgcolor="#5B7CFF" class="TestoContenuto"><label for="server_uphops"></label>
                  ...
                  <?php while($result_upho = mysql_fetch_assoc($query_upho)) {
					  $uphops = "{ " . $result_upho['reshare_value'] . " }";
					   ?>
                    <option value="<?php echo $uphops;;?>" <?php if($result_server['server_uphops'] == $uphops) { echo " selected=\"selected\""; }?>><?php echo $uphops;?></option>
                    <?php }?>
                  </select></td>
              </tr>
              <tr>
                <td height="20" bgcolor="#5B7CFF" class="TestoContenuto">&nbsp;</td>
                <td height="20" bgcolor="#5B7CFF" class="TestoContenuto"><input name="button2" type="submit" class="LoginBox" id="button2" value="Update" />
                  <input name="update" type="hidden" id="update" value="server" />
                  <input name="server_id" type="hidden" id="server_id" value="<?php echo $_GET['server_id'];?>" /></td>
              </tr>
            </table>
          </form>
<br /></td>
