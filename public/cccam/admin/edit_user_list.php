        ...
        <td valign="top" bgcolor="#84C1DF"><table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <table width="650" border="0" align="center" cellpadding="0" cellspacing="1">
            <?php while($result_list_user = mysql_fetch_array($query_list_user)) {
				...
				?>
            <tr>
                <td width="150" height="20" bgcolor="#5B7CFF" class="TestoContenuto"><?php echo "<div title='Total Fline " .$result_list_user['sum']."'><a href='edit_user.php?user_id=".$result_list_user['user_id']."'>". $result_list_user['user_username']."</a> (".$result_list_user['sum'].") </div>";?></td>
