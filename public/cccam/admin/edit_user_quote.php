...
$sql_edit = "SELECT * FROM cccam_quote WHERE user_id = '$user_id' ";
            ...
            <table width="650" border="0" align="center" cellpadding="0" cellspacing="1">
              <tr>
                ...
                <td bgcolor="#5B7CFF"><label for="user_name"></label>
                  <input name="quote_value" type="text" class="LoginBox" id="quote_value" value="<?php echo $result_edit['quote_value'];?>" /></td>
              </tr>
              <tr>
                <td bgcolor="#5B7CFF" class="TestoContenuto">From ::</td>
                <td bgcolor="#5B7CFF"><input name="quote_from" type="text" class="LoginBox" id="quote_from" value="<?php echo $result_edit['quote_from'];?>" />
...
alt="Datepicker" border="0" /></a></td>
              ...
              <tr>
                ...
                <td bgcolor="#5B7CFF"><label for="fline_uphops"></label>
                  <input name="quote_to" type="text" class="LoginBox" id="quote_to" value="<?php echo $result_edit['quote_to'];?>" />
...
alt="Datepicker" border="0" /></a></td>
              ...
              <tr>
                ...
                <td><input name="edit" type="hidden" id="edit" value="quote" />
