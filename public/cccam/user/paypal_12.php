...
$currency = $result_query['paypal_cur_12'];
...
switch ($_GET['action']) {
   ...
   case 'process':      // Process and order...
      ...
      $p->add_field('item_name', 'Quota Socio : '.$_SESSION['username'].' , 12 mesi ');
   ...
   case 'success':      // Order was successful...
	  ...
	  $new_date = strtotime(date("d-m-Y", strtotime($old_date)) . " +12 month");
	  $value = date("d-m-Y",$new_date);
	  
	  // Update the database with new date
	  
	  $new_quote = "300"; // Change if need
	  $today = date("d-m-Y");
