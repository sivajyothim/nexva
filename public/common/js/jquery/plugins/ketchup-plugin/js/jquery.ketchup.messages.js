$.fn.ketchup.messages = {
  ...
  'buildname':    'Name must contain only numbers, characters, space, "-" and "_".',     //this is a custom message, used for validate buildname in the CP panel
  'briefdescription':	'This field must have a length between $arg1 and $arg2 characters.'
};