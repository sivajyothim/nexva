...
class soap_transport_http extends nusoap_base {
	...
	*/
	function soap_transport_http($url, $curl_options = NULL, $use_curl = false){
		...
		$this->setHeader('User-Agent', 'NeXva /3.1/1.0');
		$this->setHeader('Date', date('l jS F Y'));
	//	$this->setHeader('Authorization', 'Basic Y2dzZHBjaGFyZ2luZzpjZ3NkcGNoYXJnaW5nQDEyMw==');
    	//$this->setHeader('Authorization', 'Basic TmVYdmE6TmVYdmFAMTIz');
	}
...
* @access   public
*/
class xmlrpc_client extends nusoap_base  {
	...
	* @access   public
	*/
	function xmlrpc_client($endpoint,$wsdl = false,$proxyhost = false,$proxyport = false,$proxyusername = false, $proxypassword = false, $timeout = 0, $response_timeout = 30, $portName = ''){
