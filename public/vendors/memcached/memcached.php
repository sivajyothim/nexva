...
define('ADMIN_USERNAME','nexva'); 	// Admin Username
define('ADMIN_PASSWORD','nexva90210');  	// Admin Password
...
<div class="head">
	<h1 class="memcache">
		<span class="logo"><a href="memcached.php">neXva Memcached Monitor</a></span>
