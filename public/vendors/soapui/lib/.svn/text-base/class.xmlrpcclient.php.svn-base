...
* @access   public
*/
class xmlrpc_client extends xmlrpc_base  {
	...
	* @access   public
	*/
	function xmlrpc_client($endpoint,$wsdl = false,$proxyhost = false,$proxyport = false,$proxyusername = false, $proxypassword = false, $timeout = 0, $response_timeout = 30){
		parent::nusoap_base();
